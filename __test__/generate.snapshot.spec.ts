...
// The banner regex and the static-template list come from the module the
// regenerator writes with, so reader and writer cannot drift.
import { BANNER_RE, STATIC_TEMPLATE_PATHS } from '../scripts/lib/snapshot-layout.ts';
