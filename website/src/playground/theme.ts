...
const theme = EditorView.theme({
  ...
  '.cm-activeLineGutter': {
    backgroundColor: 'var(--pg-active-line)',
    color: 'var(--pg-gutter-active)',
  },
  ...
  '.cm-selectionMatch, &.cm-focused .cm-matchingBracket': {
    backgroundColor: 'var(--pg-bracket)',
  },
  '.cm-searchMatch': { backgroundColor: 'var(--pg-match)' },
  '.cm-searchMatch.cm-searchMatch-selected': {
    backgroundColor: 'var(--pg-match-selected)',
  },
  '.cm-panels': {
...
const highlight = HighlightStyle.define([
  ...
  {
    tag: [tags.function(tags.variableName), tags.function(tags.propertyName), tags.meta],
    class: 'tok-function',
  },
...
const yamlHighlight = HighlightStyle.define(
  [
    ...
    {
      tag: [tags.content, tags.string, tags.special(tags.string)],
      class: 'tok-yaml-value',
    },
  ],
  { scope: yamlLanguage },
);
