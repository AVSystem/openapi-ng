...
| `E_UNSUPPORTED_RUNTIME` | The package was loaded in a non-Node runtime (e.g. a browser bundle resolved `@avsystem/openapi-ng/browser.js`). | Run the generator from Node only; remove `@avsystem/openapi-ng` from browser bundles or alias it away. See [Runtime & platforms](/reference/runtime/). |
